                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            ...
                                            <div class="input-group input-medium date date-picker"  data-date-format="yyyy-mm-dd" data-date-viewmode="years">
                                                <input class="form-control" data-date-format="yyyy-mm-dd" type="text" name="from_date" id="from_date" placeholder="From Date" readonly />                                                 <span class="input-group-btn">
                                                     <button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
                                                     </span>
                                            </div>
                                            <h4>End Date</h4>
                                            <div class="input-group input-medium date date-picker"  data-date-format="yyyy-mm-dd" data-date-viewmode="years">
                                                <input class="form-control" data-date-format="yyyy-mm-dd" type="text" name="to_date" id="to_date" class="form-control" placeholder="To Date" readonly/>                                                  <span class="input-group-btn">
                                                         <button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
                                                         </span>
                                            </div>
                                        </div>
