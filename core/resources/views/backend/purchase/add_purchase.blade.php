                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box blue-ebonyclay">
                        ...
                        <div class="portlet-body form">
                            ...
                            <!------------------------ BEGIN FORM---------------------->
                            <form method="POST" action="{{route('purchase.store')}}" accept-charset="UTF-8" class="form-horizontal form-bordered">
                                {{csrf_field()}}
                                <div class="form-body">
                                 ...
                                 <button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
                                    ...
                                    <div class="form-actions">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <button type="submit" class="btn blue-ebonyclay col-md-12"><i class="fa fa-check"></i>Add Purchase</button>
                                            </div>
                                        </div>
                                    </div>
                            </form>
