...
<head>
    <meta charset="utf-8" />
    <title>TheSoftKing | 404 Page </title>
    ...
    <link href="assets/backend/pages/css/error.min.css" rel="stylesheet" type="text/css" />
...
<div class="page-inner">
    <img src="assets/backend/pages/media/pages/earth.jpg" class="img-responsive" alt=""> </div>
<div class="container error-404">
    <h1>404</h1>
    <h2>Wopps, we have a problem.</h2>
