...
<body class=" login" style="background-image: url({{asset('assets/backend/img/employee.jpg')}})">
    <br>
    <br>
    <br>
    <br>
...
<div class="content"  style="background-color: lightcoral">
    ...
    <form class="login-form"  method="POST" action="{{ route('employee') }}">
        {{ csrf_field() }}
        <h3 class="form-title" style="color: black">Employee/User Login</h3>
        ...
        <div class="form-actions">
            ...
            <button type="submit" class="btn dark pull-right"> Login </button>
        </div>
    </form>

</div>

<div class="copyright" style="color: black">2018 &copy; All Right Reserved</div>
